...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/axel/software/Gitlab/Pavlovia/Choice_RT/choicertt/choiceRTT_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        # if intro_square is starting this frame...
        if intro_square.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # update status
            intro_square.status = STARTED
            intro_square.setAutoDraw(True)
        
        # if intro_square is active this frame...
        if intro_square.status == STARTED:
            # update params
            pass
        
        # *intro_plus* updates
        
        # if intro_plus is starting this frame...
        if intro_plus.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # update status
            intro_plus.status = STARTED
            intro_plus.setAutoDraw(True)
        
        # if intro_plus is active this frame...
        if intro_plus.status == STARTED:
            # update params
            pass
        
        # *intro_cross* updates
        
        # if intro_cross is starting this frame...
        if intro_cross.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # update status
            intro_cross.status = STARTED
            intro_cross.setAutoDraw(True)
        
        # if intro_cross is active this frame...
        if intro_cross.status == STARTED:
            # update params
            pass
